...
query=/home/scripts/GMO_PROD/Business_Process/queries/Request_ICE_America_Equity_check.sql
...
LogPath=$Path/logs
dtCmd="date '+ %D %T'"
logFile="Request_ICE_America_Equity_check.`date '+%d%b%g'`"
SQL_command_Action >/home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_America_Equity_check_temp.html 2>&1
sed '1d;2d;$d' /home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_America_Equity_check_temp.html > /home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_America_Equity_check.html
emailHTML=/home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_America_Equity_check.html


send_mail_success()
{

  subject="[GMO PROD][SUCCESS][America|America|EQ Req file sftp'ed successfully]"
