...
query=/home/scripts/GMO_PROD/Business_Process/queries/Request_ICE_Asia_Future_check.sql
bp=$1
bold=$(tput bold)
normal=$(tput sgr0)
...
LogPath=$Path/logs
dtCmd="date '+ %D %T'"
logFile="Request_ICE_Asia_Future_check.`date '+%d%b%g'`"
SQL_command_Action >/home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Future_check_temp.html 2>&1
sed '1d;2d;$d' /home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Future_check_temp.html > /home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Future_check.html
emailHTML=/home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Future_check.html


send_mail_success()
{

  subject="[GMO PROD][SUCCESS][Asia|Asia|C37075_FAREAST Req file sftp'ed successfully]"
...
then
        ...
        echo '' | mailx -s "[GMO PROD][Alert][Asia|Asia|C37075_FAREAST sftp failed - Pls check]" -r gmo_prod_alert $recipient_tckt
