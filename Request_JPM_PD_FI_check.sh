...
query=/home/scripts/GMO_PROD/Business_Process/queries/Request_JPM_PD_FI_check.sql
...
LogPath=$Path/logs
dtCmd="date '+ %D %T'"
logFile="Request_JPM_PD_FI_check.`date '+%d%b%g'`"
SQL_command_Action >/home/scripts/GMO_PROD/Business_Process/html_files/Request_JPM_PD_FI_check_temp.html 2>&1
sed '1d;2d;$d' /home/scripts/GMO_PROD/Business_Process/html_files/Request_JPM_PD_FI_check_temp.html > /home/scripts/GMO_PROD/Business_Process/html_files/Request_JPM_PD_FI_check.html
emailHTML=/home/scripts/GMO_PROD/Business_Process/html_files/Request_JPM_PD_FI_check.html


send_mail_success()
{

  subject="[GMO PROD][SUCCESS][description_JPM_PD Req file sftp'ed successfully]"
...
then
        ...
        echo '' | mailx -s "[GMO PROD][Alert][description_JPM_PD sftp failed - Pls check]" -r gmo_prod_alert $recipients_fail
