...
query=/home/scripts/GMO_PROD/Business_Process/queries/Request_ICE_Asia_Equity_check.sql
...
LogPath=$Path/logs
dtCmd="date '+ %D %T'"
logFile="Request_ICE_Asia_Equity_check.`date '+%d%b%g'`"
SQL_command_Action >/home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Equity_check_temp.html 2>&1
sed '1d;2d;$d' /home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Equity_check_temp.html > /home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Equity_check.html
emailHTML=/home/scripts/GMO_PROD/Business_Process/html_files/Request_ICE_Asia_Equity_check.html


send_mail_success()
{

  subject="[GMO PROD][SUCCESS][Asia|Asia|ASIA Req file sftp'ed successfully]"
...
then
        ...
        echo '' | mailx -s "[GMO PROD][Alert][Asia|Asia|ASIA sftp failed - Pls check]" -r gmo_prod_alert $recipients_fail
