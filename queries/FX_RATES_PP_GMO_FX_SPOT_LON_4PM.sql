...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%FX_RATES_PP_GMO_FX_SPOT_LON_4PM%' and trunc(created)=trunc(sysdate)
