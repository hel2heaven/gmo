...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%GMO_ASIA_FUTURE_OPTION_PP_GMO_ASIA_FUTURE_OPTION%' and trunc(created)=trunc(sysdate)
