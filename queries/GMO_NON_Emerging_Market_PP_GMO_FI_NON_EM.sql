...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%GMO_NON_EMERGING_MARKET_PP_GMO_FI_NON_EM%' and trunc(created)=trunc(sysdate)
