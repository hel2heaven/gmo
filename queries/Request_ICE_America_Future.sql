...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%America|Americas|A37075_America%' and trunc(created)=trunc(sysdate)
