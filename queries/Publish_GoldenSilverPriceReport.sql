...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%Publish_GoldenSilverPriceReport%' and trunc(created)=trunc(sysdate)
