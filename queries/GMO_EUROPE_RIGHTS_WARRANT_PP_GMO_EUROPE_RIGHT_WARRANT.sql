...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%GMO_EUROPE_RIGHTS_WARRANT_PP_GMO_EUROPE_RIGHT_WARRANT %' and trunc(created)=trunc(sysdate)
