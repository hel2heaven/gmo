...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%GMO_US_RIGHTS_WARRANT_PP_GMO_US_RIGHT_WARRANT%' and trunc(created)=trunc(sysdate)
