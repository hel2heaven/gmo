...
else 'No status' end as LastWaitingfor from S_BUSINESSWORKREQUEST where description like '%GMO_EUROPE_PP_GMO_EUROPE_EQUITY%' and trunc(created)=trunc(sysdate)
